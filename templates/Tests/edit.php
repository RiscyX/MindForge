...
$builderConfig = [
    ...
    'aiStrings' => [
        ...
        'generationInProgress' => __('AI is generating your quiz...'),
        'generationInfo' => __('The AI is composing questions, answers and translations. This may take up to 30 seconds.'),
        'trueLabel' => __('True'),
        'falseLabel' => __('False'),
