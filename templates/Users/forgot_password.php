...
<div class="container-fluid p-0 flex-grow-1 d-flex">
    <div class="flex-grow-1 d-flex align-items-center justify-content-center p-3 p-sm-4 p-lg-5">
        <div class="mf-card p-4 p-sm-5">
            <h2 class="mb-1"><?= __('Forgot your password?') ?></h2>
            <p class="mf-muted mb-4"><?= __('Enter your email and we\'ll send you a reset link.') ?></p>

            <?= $this->Form->create(null, [
                'url' => ['controller' => 'Users', 'action' => 'forgotPassword', 'lang' => $lang ?? 'en'],
